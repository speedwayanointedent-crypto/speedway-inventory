...
const REPORTS = [
  ...
  },
  {
    ...
    icon: PackagePlus,
    title: "Stock Intake",
    description: "Daily intake aggregation, by supplier, by product, payment status.",
  ...
  },
  {
    ...
    description: "Per-supplier purchase history, outstanding balances, payment tracking.",
  ...
  },
  {
    ...
    description: "All suppliers with contact info and lifetime purchase totals.",
  ...
  },
  {
    ...
    description: "Defective / overstock returns, refunds, by reason and supplier.",
  ...
  },
  {
    ...
    description: "Products below reorder point, reorder quantities, supplier link.",
